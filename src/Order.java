...
public class Order{
	...
	public static void main(String [] args){
		...
		SinglePoint singlelist [] = {new SinglePoint(1),new SinglePoint(2),new SinglePoint(3),new SinglePoint(4),new SinglePoint(5),new SinglePoint(6),new SinglePoint(7),new SinglePoint(8),new SinglePoint(9),new SinglePoint(10),};//單點項目
		SetMeal setlist [] = {new SetMeal(2,1),new SetMeal(2,2),new SetMeal(2,3),new SetMeal(7,1),new SetMeal(7,2),new SetMeal(7,3),new SetMeal(9,1),new SetMeal(9,2),new SetMeal(9,3)};//套餐項目
		while(quit != 2){
		...
		for(int i = 0; i < 10; i++){
			...
			if(Singlecount[i] > 0){
				...
				System.out.println(singlelist[i] + "  x" + Singlecount[i] + "        " + singlelist[i].getPrice() * Singlecount[i] + "元\n");
